...
def main() -> None:
    ...
    chunk_parser=subparsers.add_parser("chunk",help="Used for chunking")
    chunk_parser.add_argument("arg",type=str,help="Arg for the ptext to chunk")
    ...
    match args.command:
        ...
        case "chunk":
            chunk_text(args.arg,args.chunk_size)
        case _:
            parser.print_help()
